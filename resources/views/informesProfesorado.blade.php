<!--Vista para subir datos de archivos PDF de informes del profesorado-->
@extends('layouts.app')
...
@endif
@section('content')
    <h1>Informes del profesorado sobre las prácticas en empresas</h1>
        <form id="subir" name="subir" action="{{route('informesProfesorado.store')}}" method="POST" enctype="multipart/form-data">
        @csrf

            ...
            <form method="POST"
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="actividades_formativas_y_tareas_que_realiza_la_empresa">Actividades formativas y
                        ...
                        <div class="form-group">
                            <label for="actividades_y_tareas_que_estas_realizando_en_la_empresa">Actividades y tareas
                                que estas realizando en la empresa:
                            </label>
                        ...
                        <div>
                            <p>Posibilidades formativas que ofrece la empresa:</p>
                        ...
                        <div>
                            <p>Cumplimiento del programa formativo por parte de la empresa.</p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio"
                        ...
                        <div>
                            <p>Seguimiento realizado por el tutor/a del centro de trabajo.</p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio"
                        ...
                        <div>
                            <p>Seguimiento hecho por tu profesor/a.</p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio"
                        ...
                        <div>
                            <p>Adecuación de la formación recibida en el centro docente con las prácticas realizadas.
                            </p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio"
                        ...
                        <div>
                            <p>Integración en el entorno laboral.</p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio"
                        ...
                        <div class="form-group">
                            <label for="sugerencias_de_mejora">Sugerencias generales de mejora.</label>
                            <textarea class="form-control" name="sugerencias_de_mejora" id="sugerencias_de_mejora" rows="3"></textarea>
                        </div>

                        <div>
                            <p>Valoración general de las prácticas.</p>
                            <div class="form-check">
                                <input class="form-check-input" type="radio"

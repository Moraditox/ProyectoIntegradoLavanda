                    ...
                    <div class="col-md-4 mb-4 d-flex align-items-stretch">
                        <div class="card h-100 shadow border-0 rounded-4 w-100">
                            <div class="card-body d-flex flex-column align-items-center">
                                <div class="mb-3">
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($alumno['nombre'] . ' ' . $alumno['apellido1']) }}&background=6c63ff&color=fff&size=80"
                                        alt="Avatar" class="rounded-circle shadow-sm" width="80" height="80">
                                </div>
                                <h5 class="card-title fw-bold text-primary">{{ $alumno["nombre"] }} {{ $alumno["apellido1"] }}
                                    {{ $alumno["apellido2"] }}</h5>
                                ...
                                <a href="{{ url('/alumnos/' . $alumno['id']) }}" class="btn btn-primary mt-3">
                                    Ver alumno
                                </a>
                            </div>
                        </div>

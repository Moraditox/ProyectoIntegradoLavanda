<!--Vista para subir datos de archivos PDF de informes de los tutores laborales-->
@extends('layouts.app')
...
@endif
@section('content')
    <h1>Informes de los tutores laborales sobre las prácticas en empresas</h1>
        <form id="subir" name="subir" action="{{route('informesTutoresLaborales.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <div class="container">
        ...
        @else
            <p>No hay informes del profesorado.</p>
        @endif
        </div>
    </div>
